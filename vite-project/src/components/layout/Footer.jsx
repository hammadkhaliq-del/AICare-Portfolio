    ...
    return (
      <footer className="bg-gray-900 text-gray-300">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-5">
          ...
          {/* Email Subscription Section - Simple, no background box */}
              ...
              <div className="w-full md:w-5/12">
                <form className="flex">
                    ...
                    <button 
                        ...
                        className="bg-white ml-4 text-gray-900 font-semibold px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors duration-200 cursor-pointer"
                    >
                        Subscribe
                    </button>
                </form>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            <div className="text-lg text-gray-500 flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
                <p>&copy; {new Date().getFullYear()} AI Care. All rights reserved.</p>
                <p className="text-lg">Backed by MIDL — National Center of Artificial Intelligence (NCAI)</p>
            </div>
          </div>
        </div>
      </footer>
